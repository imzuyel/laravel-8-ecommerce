(function ($) {
    ...
    let kallesInitTimzone = (T) => {
        ...
        kallesIsVisible = (el, partial, hidden, direction, container) => {
            ...
            var $w = $(window),
                ...
                isContained =
                    typeof container !== "undefined" && container !== null,
            ...
            if (typeof t.getBoundingClientRect === "function") {
                ...
                var rec = t.getBoundingClientRect(),
                    ...
                    hVisible =
                        rec.left < 0 && rec.right > vpWidth ? true : hVisible;
    ...
    $.fn.hTransparent = function () {
        ...
        h_banner.on("click", ".h_banner_close", function (e) {
            ...
            let date = parseInt(
                h_banner.find(".h__banner").attr("data-date"),
                10
            );
            if (date) {
    ...
    $.fn.initCountdown_pr = function () {
        $(this).each(function () {
            ...
            $id.countdown(dta_time, { elapse: true }).on(
                "update.countdown",
                function (event) {
                    if (event.elapsed) {
                        $id.html("");
        ...
        if ($(window).width() > 767) {
            $(this).each(function () {
                ...
                if (nav_dropdownWidth >= 0 && li.hasClass("menu_center")) {
                    ...
                    (nav_dropdownOffset.left + nav_dropdownWidth >=
                        viewportWidth ||
                        li.hasClass("menu_wid_full")) &&
                    li.hasClass("menu_has_offsets")
                ) {
    ...
    $.fn.kallesMobileNav = function () {
        ...
        $(this).on(
            "click",
            ".menu-item-has-children .nav_link_icon",
            function (e) {
                e.preventDefault();
                e.stopPropagation();
        ...
        $window.on("scroll", function () {
            ...
            if (isHideOnScroll) {
                ...
                if (
                    ...
                    $header
                        .addClass("h_scroll_up")
                        .removeClass("h_scroll_down");
                } else if (currentScroll <= offset) {
                    $header.removeClass("h_scroll_down h_scroll_up");
                } else {
                    $header
                        .addClass("h_scroll_down")
                        .removeClass("h_scroll_up");
                }
                prevScrollpos = currentScrollPos;
            }
        });
    ...
    $.fn.parallax = function () {
        if ($(this).length > 0) {
            refresh_parallax();
            $(".nt_parallax_true:not(.lazyloaded)").one(
                "lazyloaded",
                function (e) {
                    setTimeout(function () {
                        refresh_parallax();
            ...
            function refresh_parallax(el) {
                var elm =
                    el ||
                    $(".nt_parallax_true.lazyloaded:not(.js_ralax_doned)");
                ...
                var showPopup = function () {
                    $.magnificPopup.open({
                        ...
                        callbacks: {
                            beforeOpen: function () {
                                this.st.mainClass =
                                    "mfp-move-horizontal new_pp_wrapper";
                            },
                            open: function () {
    ...
    $.fn.kallesSwatches = function () {
        if ($(this).length) {
            body.on(
                "click",
                ".swatch_pr_item:not(.is-selected)",
                function (evt) {
                    evt.preventDefault();
                    let $this = $(this);
                    $this
                    ...
                    if ($this.data("index")) {
                        ...
                        if ($main_slide) {
                            $main_slide
                                .flickity()
                                .flickity("select", $this.data("index"));
                        }
                    }
                    if ($this.data("filter")) {
                        let $p_thumb = $this
                        ...
                        if ($p_thumb.length && Array.isArray(options)) {
                            ...
                            $(".p-thumb.only_owl_mb").kallesProductIsotope(
                                !is_smaller_768
                            );
            ...
            let showPopup = function () {
                $.magnificPopup.open({
                    ...
                    callbacks: {
                        beforeOpen: function () {
                            this.st.mainClass =
                                "mfp-move-horizontal age_pp_wrapper";
                        },
                    },
                });
            };
                ...
                $col_nav
                    ...
                    .on("click", function (e) {
                        let $this = $(this),
                            ...
                            navHeight = $el.height(),
                            navCellHeight =
                                slider_height / $el.find(".n-item").length,
                            currentScrollTop = $el.scrollTop();
                        if (
                            ($this.hasClass("btn_pnav_prev") &&
                                currentScrollTop <= 0) ||
    ...
    $.fn.kallesInitFeaturedProduct = function () {
        let $objects = $(this).find(
            "[data-pr-md-tp-video],[data-pr-md-tp-model]"
        );
        ...
        if ($objects.length) {
            ...
            const createPlayer = function (media) {
                ...
                if (media.host === "html5") {
                    ...
                    if (
                        $carousel.length &&
                        $carousel.hasClass("is-draggable")
                    ) {
                        media.player.on("play", function () {
                            /*Disable dragging*/
                            updateDraggableFlickity(
                    ...
                    media.element.addEventListener("load", function () {
                        ...
                        media.container
                            ...
                            .addClass(
                                "kalles-model-viewer-ui__controls-area--playing"
                            );
                        $(this)
                            .find("#userInput")
                        ...
                        function (evt) {
                            ...
                            if (
                                ...
                                if ($wrapModel[0].requestFullscreen) {
                                    ...
                                    $wrapModel[0].webkitRequestFullscreen
                                ) {
                                    /* Safari */
                                    $wrapModel[0]
            ...
            $objects.each(function () {
                let $this = $(this),
                    ...
                    isVideoObject = $this[0].hasAttribute(
                        "data-pr-md-tp-video"
                    ),
                    media = {
    ...
    $.fn.kallesButtonShowGallery = function () {
        if ($(this).length) {
            ...
            let adjustMobileThumbPosition = function () {
                ...
                if (
                    thumbBounds.left + thumbBounds.width >
                    ...
                    selectedThumb.offsetLeft < thumbContainer.scrollLeft
                ) {
                    $pswp__thumb.animate(
            ...
            $(this).on("click", ".show_btn_pr_gallery", function (e) {
                ...
                if (p_thumb.length > 0 && img_visible.length > 1) {
                    ...
                    $(".pswp_thumb_item:eq(" + index + ")").addClass(
                        "pswp_tb_active"
                    );
                    adjustMobileThumbPosition();
                }
            ...
            if (
                $productGallery.hasClass("img_action_zoom") &&
                window_w > 1025
            ) {
        ...
        if ($(this).length) {
            $(this).on(
                ...
                function (e) {
                    ...
                    let $this = $(this),
                        pr = $this.closest(
                            ".nt_lt_fake , .kalles_dropdown_container"
                        );
                    ...
                    if ($(pr).hasClass("opended")) {
                        ...
                        $(pr.closest(".dropdown_picker_js"))
                            .find(
                                ".nt_lt_fake.opended ,.kalles_dropdown_container.opended"
                            )
                            .removeClass("opended");
                        $(pr).addClass("opended");
                    }
        ...
        if ($(this).length) {
            body.on("click", ".cat_view a:not(.active)", function (e) {
                ...
                let $this = $(this),
                    ...
                    $catView_holder = $(
                        ".cat_view,.container_cat .nt_products_holder"
                    );
    ...
    $.fn.kallesRefreshPriceTitle = function () {
        if ($(this).length) {
            function price_slider_create(values) {
                $("[data-js-minprice]").html(
                    formatMoney(parseInt(values[0], 10))
                );
                $("[data-js-maxprice]").html(
                    formatMoney(parseInt(values[1], 10))
                );
            }
            ...
            $(this).each(function () {
                ...
                _amount
                    ...
                    .hide();
                _this
                    .find(".price_slider, .price_label ,.price_slider_btn")
                    .show();
            ...
            let showPopup = function () {
                $.magnificPopup.open({
                    ...
                    callbacks: {
                        beforeOpen: function () {
                            this.st.mainClass =
                                "mfp-move-horizontal prpr_pp_wrapper";
                        },
                        open: function () {
                            ...
                            $wrap_popup
                                .find(
                                    ".pr_coun_dt:not(.done_cd) , .sepr_coun_dt:not(.done_cd)"
                                )
                                .initCountdown();
    ...
    $.fn.kallesPaymentMethodDropdown = function () {
        if ($(this).length) {
            $(this).on("change", function () {
                $(this)
                    .closest(".payment_methods")
                    .find(".payment_box")
                    .slideUp(300);
                $(this)
                    .closest(".payment_method")
                    .find(".payment_box")
                    .slideDown(300);
                /*$( this ).is( ":checked" )
    ...
    if (window_w >= 1024) {
        body.on("click", ".pin_tt_js", function (e) {
            ...
            $(".pin__slider.pin_slider_opened").removeClass(
                "pin_slider_opened"
            );
        ...
        if ($window.width() > 1024) {
            ...
            if (html.hasClass("browser-Safari")) {
                const footerSafariFix = function () {
                    let windowScroll = $window.scrollTop(),
                        footerOffsetTop =
                            $(document).outerHeight() - $footer.outerHeight();
    ...
    if (
        ...
        let $cart = $("#nt_cart_canvas"),
            ...
            right =
                windowWidth -
                ($icon_cart.offset().left + $icon_cart.outerWidth()),
    ...
    if ($(".sp-tabs .tab-heading").length) {
        $(document).on("click", ".sp-tabs .tab-heading", function (e) {
            ...
            if (parent.hasClass("active")) {
                ...
                setTimeout(function () {
                    parent
                        .find(".sp-tab-content .js_packery")
                        .packery("layout");
                    var el_active = parent_top.find(
                        ".sp-tab.active .js_ck_view"
                    );
            ...
            setTimeout(() => {
                ...
                $wrapItem.slideUp(300, "swing", function () {
                    ...
                    if (!$nt_js_cart.find(".mini_cart_item").length) {
                        $nt_js_cart
                            .find(".mini_cart_items , .mini_cart_tool")
                            .remove();
                        $nt_js_cart
                            .find(".empty.tc")
                            .show(300, "swing", function () {
                                $(this).removeClass("dn");
                            });
                    }
