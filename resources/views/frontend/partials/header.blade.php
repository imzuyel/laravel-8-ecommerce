              ...
              <div class="row al_center">
                ...
                <div class="col-lg-3 col-12 tc col-md-12 tr_lg dn_false_1024">
                  <div class="nt_currency pr cg currencies sp_currencies wsn dib cur_stt_0">
                    ...
                    <span class="nt-currency-flag--usd--w16-h-12 active ">ভাষা</span><i class="facl facl-angle-down ml__5"></i>
                    @else
                    <span class="nt-currency-flag--usd--w16-h-12 active ">Language</span><i class="facl facl-angle-down ml__5"></i>
                    @endif

                    <ul class="pa pe_none ts__03 bgbl ul_none tl op__0 z_100 r__0 pt__15 pb__15 pr__15 pl__15">
                      <li><a class="nt-currency-flag--aud--w16-h-12 cg db" href="{{ route('language.english') }}">English</a></li>
                      <li><a class="nt-currency-flag--cad--w16-h-12 cg db" href="{{ route('language.bangla') }}">বাংলা</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="row no-gutters al_center">
                <div class="col-auto ha8_cat">
                  ...
                  <div class="h_cat_nav pa op__0 mh_js_cat">
                    <ul class="lazy_menu lazy_h_cat lazyload" role="menu" aria-labelledby="dropdownMenu">
                      @foreach ($categories as $category)
                      @if (count($category->subcategories)>0)
                      <li class="dropdown-submenu">
                        <a class="dropdown-item text-cyne" href="#"> <i class="{{ $category->icon }}" style="font-size:18px;"></i><span class="px-2">{{ $category->category_name_bn }}</span></a>
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="#">{{ $subsubcategory->subsubcategory_name_bn }}</a></li>
                              @endforeach

                            </ul>
                          </li>
                          @else
                          <li><a class="dropdown-item" tabindex="-1" href="#">{{ $subcategory->subcategory_name_bn }}</a></li>
                          @endif
                          @endforeach
                        </ul>
                      </li>
                      @else
                      <li class="cat_menu-0">
                        <a class="lh__1 flex al_center pr" href="#"><i class="las la-mobile"></i>{{ $category->category_name_bn }}</a>
                      </li>
                      @endif
                      @endforeach
                    </ul>
                  ...
                  <nav class="nt_navigation tl hover_side_up nav_arrow_false">
                    <ul id="nt_menu_id" class="nt_menu in_flex wrap al_center">
                      <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                        <a class="lh__1 flex al_center pr" href="blog-grid.html">হোম</a>
                      </li>
                    </ul>
                  </nav>
                </div>
                <div class="col-3 fs__12 ha8_txt tr">
                  <a href="" class="ttip_nt tooltip_top mr__10">
                    <span class="tt_txt"><span class="__cf_email__" data-cfemail="a6cdc7cacac3d5e6c2c9cbc7cfc888c5c9cb">Ecommerce</span></span>
                  ...
                  <div class="col-auto ha8_cat">
                    ...
                    <div class="h_cat_nav pa op__0 mh_js_cat">
                      <ul class="lazy_menu lazy_h_cat lazyload" role="menu" aria-labelledby="dropdownMenu">
                        ...
                        @if (count($category->subcategories)>0)
                        <li class="dropdown-submenu">
                          <a class="dropdown-item text-cyne" href="#"> <i class="{{ $category->icon }}" style="font-size:18px;"></i><span class="px-2">{{ $category->category_name_en }}</span></a>
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                              ...
                              <ul class="dropdown-menu">
                                @foreach ($subcategory->subsubcategories as $subsubcategory)
                                <li><a class="dropdown-item" href="#">{{ $subsubcategory->subsubcategory_name_en }}</a></li>
                                @endforeach

                              </ul>
                            </li>
                            @else
                            <li><a class="dropdown-item" tabindex="-1" href="#">{{ $subcategory->subcategory_name_en }}</a></li>
                            @endif
                            @endforeach
                          </ul>
                        </li>
                        @else
                        <li class="cat_menu-0">
                          <a class="lh__1 flex al_center pr" href="#"><i class="las la-mobile"></i>{{ $category->category_name_en }}</a>
                        </li>
                        @endif
                        @endforeach
                      </ul>
