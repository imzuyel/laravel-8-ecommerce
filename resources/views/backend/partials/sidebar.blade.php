  ...
  <ul class="metismenu" id="menu">
    ...
    <li class="{{ Request::is('app/brands/*') ? 'mm-active' : '' }}">
      ...
      <ul class="{{ Request::is('app/brands*') ? 'mm-show' : '' }}">
        ...
        <li class="{{ Request::is('app/brands') ? 'mm-active' : '' }}{{ Request::is('app/brands/*/edit') ? 'mm-active' : '' }}">
    ...
    Auth::user()->hasPermission('app.categories.create'))
    <li>
      <a class="has-arrow" href="javascript:;">
      ...
      <ul class="{{ Request::is('app/categories*') ? 'mm-show' : '' }}">
        ...
        <li class="{{ Request::is('app/categories/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/categories*') ? 'mm-show' : '' }}">
            ...
            @endif
            @if (Auth::user()->hasPermission('app.categories.index'))
            <li class="{{ Request::is('app/categories') ? 'mm-active' : '' }}{{ Request::is('app/categories/*/edit') ? 'mm-active' : '' }}">
        ...
        <li class="{{ Request::is('app/subcategories/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/subcategories*') ? 'mm-show' : '' }}">
            ...
            @endif
            @if (Auth::user()->hasPermission('app.categories.index'))
            <li class="{{ Request::is('app/subcategories') ? 'mm-active' : '' }}{{ Request::is('app/subcategories/*/edit') ? 'mm-active' : '' }}">
        ...
        <li class="{{ Request::is('app/subsubcategories/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/subsubcategories*') ? 'mm-show' : '' }}">
            ...
            @endif
            @if (Auth::user()->hasPermission('app.categories.index'))
            <li class="{{ Request::is('app/subsubcategories') ? 'mm-active' : '' }}{{ Request::is('app/subsubcategories/*/edit') ? 'mm-active' : '' }}">
    ...
    <li class="{{ Request::is('app/users/*') ? 'mm-active' : '' }}">
      ...
      <ul class="{{ Request::is('app/users*') ? 'mm-show' : '' }}">
        ...
        @endif
        @if (Auth::user()->hasPermission('app.users.create'))
        <li class="{{ Request::is('app/users') ? 'mm-active' : '' }}{{ Request::is('app/users/*/edit') ? 'mm-active' : '' }}">
    ...
    <li class="{{ Request::is('app/roles/*') ? 'mm-active' : '' }}">
      ...
      <ul class="{{ Request::is('app/roles*') ? 'mm-show' : '' }}">
        ...
        @endif
        @if (Auth::user()->hasPermission('app.roles.create'))
        <li class="{{ Request::is('app/roles') ? 'mm-active' : '' }}{{ Request::is('app/roles/*/edit') ? 'mm-active' : '' }}">
    ...
    ||Auth::user()->hasPermission('app.settings.database')|| Auth::user()->hasPermission('app.settings.mail')||
    ...
    {{-- <li class="{{ Request::is('app/category/*') ? 'mm-active' : '' }}">
    <a class="has-arrow" href="javascript:;">
      <div class="parent-icon icon-color-3"><i class="bx bx-receipt"></i>
      </div>
      <div class="menu-title">Category</div>
    </a>
    <ul class="{{ Request::is('app/category*') ? 'mm-show' : '' }}">

      <li class="{{ Request::is('app/category/create/') ? 'mm-active' : '' }}">
        <a href="{{ route('app.category.create') }}"><i class="bx bx-plus"></i>
          Create
        </a>
      </li>
      <li class="{{ Request::is('app/category') ? 'mm-active' : '' }}{{ Request::is('app/category/*/edit') ? 'mm-active' : '' }}">
        <a href="{{ route('app.category.index') }}"><i class="bx bx-star"></i>Manage</a>
      </li>
    </ul>
    </li>

    <li class="{{ Request::is('app/subcategory/*') ? 'mm-active' : '' }}">
      <a class="has-arrow" href="javascript:;">
        <div class="parent-icon icon-color-3"><i class="bx bx-receipt"></i>
        </div>
        <div class="menu-title">SubCategory</div>
      </a>
      <ul class="{{ Request::is('app/subcategory*') ? 'mm-show' : '' }}">

        <li class="{{ Request::is('app/subcategory/create/') ? 'mm-active' : '' }}">
          <a href="{{ route('app.subcategory.create') }}"><i class="bx bx-plus"></i>
            Create
          </a>
        </li>
        <li class="{{ Request::is('app/subcategory') ? 'mm-active' : '' }}{{ Request::is('app/subcategory/*/edit') ? 'mm-active' : '' }}">
          <a href="{{ route('app.subcategory.index') }}"><i class="bx bx-star"></i>Manage</a>
        </li>
      </ul>
    </li>

    <li class="{{ Request::is('app/post/*') ? 'mm-active' : '' }}">
      <a class="has-arrow" href="javascript:;">
        <div class="parent-icon icon-color-3"><i class="bx bx-receipt"></i>
        </div>
        <div class="menu-title">Post</div>
      </a>
      <ul class="{{ Request::is('app/post*') ? 'mm-show' : '' }}">

        <li class="{{ Request::is('app/post/create/') ? 'mm-active' : '' }}">
          <a href="{{ route('app.post.create') }}"><i class="bx bx-plus"></i>
            Create
          </a>
        </li>
        <li class="{{ Request::is('app/post') ? 'mm-active' : '' }}{{ Request::is('app/post/*/edit') ? 'mm-active' : '' }}">
          <a href="{{ route('app.post.index') }}"><i class="bx bx-star"></i>Manage</a>
        </li>
      </ul>
    </li>
        ...
        <li class="{{ Request::is('app/division/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/division*') ? 'mm-show' : '' }}">
            ...
            <li class="{{ Request::is('app/division/create/') ? 'mm-active' : '' }}">
              <a href="{{ route('app.division.create') }}"><i class="bx bx-plus"></i>
                Create
              </a>
            </li>
            <li class="{{ Request::is('app/division') ? 'mm-active' : '' }}{{ Request::is('app/division/*/edit') ? 'mm-active' : '' }}">
              <a href="{{ route('app.division.index') }}"><i class="bx bx-star"></i>Manage</a>
            </li>
          </ul>
        </li>
        <li class="{{ Request::is('app/zilla/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/zilla*') ? 'mm-show' : '' }}">
            ...
            <li class="{{ Request::is('app/zilla/create/') ? 'mm-active' : '' }}">
              <a href="{{ route('app.zilla.create') }}"><i class="bx bx-plus"></i>
                Create
              </a>
            </li>
            <li class="{{ Request::is('app/zilla') ? 'mm-active' : '' }}{{ Request::is('app/zilla/*/edit') ? 'mm-active' : '' }}">
              <a href="{{ route('admin.zilla.index') }}"><i class="bx bx-star"></i>Manage</a>
            </li>
          </ul>
        </li>
        <li class="{{ Request::is('admin/upzilla/*') ? 'mm-active' : '' }}">
          <a class="has-arrow" href="javascript:;">
            <div class="icon-color-3"><i class="bx bx-receipt"></i>
            </div>
            <div class="menu-title">UpZilla</div>
          </a>
          <ul class="{{ Request::is('admin/upzilla*') ? 'mm-show' : '' }}">

            <li class="{{ Request::is('admin/upzilla/create/') ? 'mm-active' : '' }}">
              <a href="{{ route('admin.upzilla.create') }}"><i class="bx bx-plus"></i>
                Create
              </a>
            </li>
            <li class="{{ Request::is('admin/upzilla') ? 'mm-active' : '' }}{{ Request::is('admin/upzilla/*/edit') ? 'mm-active' : '' }}">
              <a href="{{ route('admin.upzilla.index') }}"><i class="bx bx-star"></i>Manage</a>
            </li>
          </ul>
        </li>
      </ul>
