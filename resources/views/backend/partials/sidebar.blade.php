        ...
        <li class="{{ Request::is('app/zilla/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/zilla*') ? 'mm-show' : '' }}">
            ...
            <li class="{{ Request::is('app/zilla') ? 'mm-active' : '' }}{{ Request::is('app/zilla/*/edit') ? 'mm-active' : '' }}">
              <a href="{{ route('app.zilla.index') }}"><i class="bx bx-star"></i>Manage</a>
            </li>
          </ul>
        </li>
        <li class="{{ Request::is('app/upzilla/*') ? 'mm-active' : '' }}">
          ...
          <ul class="{{ Request::is('app/upzilla*') ? 'mm-show' : '' }}">
            ...
            <li class="{{ Request::is('app/upzilla/create/') ? 'mm-active' : '' }}">
              <a href="{{ route('app.upzilla.create') }}"><i class="bx bx-plus"></i>
                Create
              </a>
            </li>
            <li class="{{ Request::is('app/upzilla') ? 'mm-active' : '' }}{{ Request::is('app/upzilla/*/edit') ? 'mm-active' : '' }}">
              <a href="{{ route('app.upzilla.index') }}"><i class="bx bx-star"></i>Manage</a>
            </li>
          </ul>
        </li>
      </ul>
