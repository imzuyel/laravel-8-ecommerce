...
<form action="{{ isset($page->id) ? route('app.pages.update', $page->id) : route('app.pages.store') }}" method="post"
                ...
                <div class="card-header border-bottom-0 mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            ...
                            <a class="btn btn-primary" href="{{ route('app.pages.index') }}" data-toggle="tooltip"
                                title="Back to pages &#9194;"><i class="bx bx-rewind"></i>Back</a>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('title') is-invalid @enderror" name="title"
                                value="{{ $page->title ?? old('title') }}" placeholder="title"
                                {{ !isset($page) ? 'required' : '' }}>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="excerpt" id="excerpt"
                                ...
                                placeholder="Short description">{{ $page->excerpt ?? old('excerpt') }}</textarea>
                            @error('excerpt')
                            <span class="text-danger" product="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" id="body" class="form-control" rows="10"
                                cols="70">{{ $page->body ?? old('body') }}</textarea>
                            @error('body')
                            <span class="text-danger" product="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input type="file" name="image" class="dropify @error('image') is-invalid @enderror"
                                data-max-file-size-preview="8M" @if (isset($page->image))
                            data-default-file="/{{ $page->image }}" @endif
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description"
                                ...
                                placeholder="Meta description">{{ $page->meta_description ?? old('meta_description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_keywords" id="meta_keywords"
                                ...
                                placeholder="Meta keywords">{{ $page->meta_keywords ?? old('meta_keywords') }}</textarea>
                            @error('meta_keywords')
                            <span class="text-danger" product="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="float-right">
                            <div class="btn-group">
                                @if (isset($page->id))
                                <button type="submit" class="btn btn-primary px-2" data-toggle="tooltip"
                                    title="Update those data &#128190;"><i class="bx bx-task"></i> Update</button>
                                @else
